...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs. makimafartporn devs'],
			['Sara Heric Productions', 'shp',   'Director, Artist, Animator, Chromatic Scales',                                                                                              'https://twitter.com/SHProds',            'FFC1DC'],
			['teotm',                  'toska', "Coder, Charter and professional procrastinator\n(it took 'e" + '${FlxG.random.bool(50) ? 'r' : 'm'} like a year to actually make a build)', 'https://twitter.com/teotm4',             '7AB9D8'],
			['Crypt Keeper',           'crypt', 'Composer',                                                                                                                                  'https://www.youtube.com/@cryptkeeper64', '08230B'],
			[''],
			['Inspired by'],
			['makimafartporn',         'mfp',   'MakimaFartPorn\n(Rest in Peace [*])',                                                                '',                                       'BA433A'],
			[''],
			['Psych Engine Team'],
