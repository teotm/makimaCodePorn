...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl = new FlxSprite(titleJSON.titlex, titleJSON.titley, Paths.image('mfp_logo'));
		logoBl.scale.set(titleJSON.logoScaleMultiplier, titleJSON.logoScaleMultiplier);
		logoBl.updateHitbox();
